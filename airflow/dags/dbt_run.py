...
with DAG(
    ...
    with TaskGroup(group_id="dBt-Pre-Build") as dbt_pre_build:
        fetch_stock_table_for_dbt_merge = MySqlOperator(
        ...
        create_all_stock_sql_file_raw = PythonOperator(
        ...
        fetch_mf_table_for_dbt_merge = MySqlOperator(
        ...
        create_all_mf_sql_file_raw = PythonOperator(
    ...
    with TaskGroup(group_id="Build-Bronze-Layer") as build_bronze_layer: 
        bronze_layer_build = BashOperator(
        ...
        bronze_layer_test = BashOperator(
